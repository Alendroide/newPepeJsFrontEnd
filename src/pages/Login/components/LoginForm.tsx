...
export default function LoginForm(){
    ...
    //HTML
    return(
        <div className="w-50 mx-auto bg-light shadow p-5 rounded-5 my-5">
                ...
                <div className="row">
                    <div className="col col-3 col-lg-6 col-sm-12">
                        ...
                        <div className="my-4">
                            ...
                            {passErr && <p>{passErr}</p>}
                            <p className="my-3">
                                No tienes una cuenta? <Link to={'/register'}><span className="text-primary">Regístrate aquí</span></Link>
                            </p>
                        </div>
